...
**Current Release: Beta than before - version 0.9**
...
The bot is distributed as an uglified version of the Typescript codebase I'm working on. This is not a community-driven codebase, but my personal screeps codebase. However I wanted to be able to distribute it as a bot, and with javascript uglifying it was the closest thing I could get to compiling it.
